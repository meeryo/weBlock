...
1. Make sure your issue [hasn't already been fixed in a recent release](https://github.com/gorhill/weBlock/releases).
1. Verify that the issue does **not** occur with weBlock disabled.
...
* A screenshot or transcription of **any of weBlock's preferences that differ from the defaults**
...
* The version of weBlock you're having the issue with; you can find this in [weBlock's popup UI](https://github.com/gorhill/weBlock/wiki/Quick-guide:-popup-user-interface)
  * Example: `weBlock 0.9.0.0`
